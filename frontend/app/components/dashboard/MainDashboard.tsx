  ...
  return (
    <div className={`min-h-full flex flex-col max-w-screen-2xl mx-auto w-full ${className}`}>
      ...
      {simplified ? (
        ...
        <div className="flex flex-col flex-1 min-h-0 gap-3 p-4 md:p-5">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5" style={{ flex: "0 1 45vh", minHeight: 0 }}>
