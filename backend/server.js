...
fastify.post("/api/tasks", { preHandler: [requireAuth] }, async (request, reply) => {
  ...
  const task = { id: nextId(), title, date: dateStr, startTime, endTime, durationMinutes, status: "pending", category, gatheringId, isAutoGenerated, assigned_by };
  taskStore.push(task);
